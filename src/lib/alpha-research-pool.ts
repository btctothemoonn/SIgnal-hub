...
export const ALPHA_RESEARCH_SECTORS: AlphaResearchSector[] = [
  {
    ...
    themeScore: 94,
    tickers: ["NVDA", "TSM", "ASML", "AMD", "ARM", "INTC", "AVGO", "LRCX"],
  },
  {
    id: "storage",
    name: "数据存储",
...
const profiles: StockProfile[] = [
  ...
  },
  {
    ...
    companyNameZh: "ARM",
    sectorId: "semiconductors",
    businessTags: ["CPU IP", "端侧 AI", "半导体设计"],
    priority: "B",
    summary: "ARM 架构授权、数据中心 CPU 渗透率和端侧 AI 设备放量决定中期估值弹性。",
    market: {
      lastPrice: 154.6,
      dayChangePct: 1.3,
      prePostChangePct: 0.2,
    ...
    catalystTitle: "数据中心 CPU 与端侧 AI 叙事延续",
    catalystType: "industry-event",
    catalystSummary:
      "市场继续跟踪 ARM 在服务器 CPU、PC/手机端 AI 设备中的授权渗透和版税增速。",
    revenue: "$1.1B",
    revenueYoY: "+15%",
    eps: "$0.35",
    grossMargin: "96.5%",
  ...
  },
  {
    ...
    priority: "A",
    summary: "存储周期和 HBM/DRAM 链条的篮子型交易工具，适合观察存储板块整体弹性。",
    market: {
      lastPrice: 46.3,
      dayChangePct: -4.9,
      prePostChangePct: 0,
      sevenDayChangePct: 18.5,
      relativeStrengthLabel: "板块篮子",
      marketSession: "regular",
      earningsStatus: "watch",
    },
    catalystTitle: "DRAM 与 HBM 价格周期强化",
    catalystType: "supply-chain",
    catalystSummary: "市场关注 DRAM 合约价、HBM 产能分配和主要内存厂商资本开支节奏。",
    revenue: "ETF basket",
    revenueYoY: "n/a",
    eps: "n/a",
    grossMargin: "n/a",
