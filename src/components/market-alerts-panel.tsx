        ...
        <div className="divide-y divide-line/80 px-4 sm:px-5">
          {ranking.map((item) => {
            ...
            return (
              <div
                key={item.symbol}
                className="grid min-h-12 grid-cols-[minmax(4.5rem,0.55fr)_minmax(8rem,1.25fr)] items-center gap-3 py-2 sm:grid-cols-[minmax(5rem,0.45fr)_minmax(10rem,1.3fr)_minmax(10rem,1fr)]"
              >
                ...
                <div className="grid grid-cols-[minmax(4rem,1fr)_auto] items-center gap-3">
...
function EventCard({ event }: { event: MarketAlertEvent }) {
