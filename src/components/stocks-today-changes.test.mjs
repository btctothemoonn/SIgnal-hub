...
assert.match(source, /上涨/);
assert.match(source, /下跌/);
assert.doesNotMatch(source, /kindLabel/);
assert.doesNotMatch(source, /item\.kind/);
assert.doesNotMatch(source, /新催化/);
assert.doesNotMatch(source, /财报/);
assert.doesNotMatch(source, /风险/);
assert.doesNotMatch(source, /数据/);
